...
public class main {
    ...
    public static void main( String[] args ) throws Exception
    {
		...
		String namafile2 = "src/main/java/error_output.txt";
		...
		String sql2 = "SELECT * FROM mahasiswa WHERE 1";
	...
	public static boolean isTglValid(String tgl) throws ParseException {
